...
require_once('classes/prpWS.php');
//require_once('class.complextypedemo.php');
// Initialize the PhpWsdl class
require_once('libs/phpwsdl/php-wsdl-2.3/class.phpwsdl.php');
...
if ($soap->IsWsdlRequested())   // WSDL requested by the client?
    $soap->Optimize = true;    // Don't optimize WSDL to send it human readable to the browser
